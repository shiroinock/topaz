...
run_fail_case await_call_arg_nested_snapshot_deeper_object_leaf_deferred_fail examples/await_call_arg_nested_snapshot_deeper_object_leaf_deferred_fail.ts "await expression lowering is deferred"
