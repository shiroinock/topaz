...
run_fail_case await_binary_array_element_prefix_update_deferred_fail examples/await_binary_array_element_prefix_update_deferred_fail.ts "await expression lowering is deferred"
