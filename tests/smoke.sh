...
run_fail_case await_call_arg_nested_call_binary_deferred_fail examples/await_call_arg_nested_call_binary_deferred_fail.ts "await expression lowering is deferred"
