...
run_case await_snapshot_prefix_update_target_descriptors $'left class\nsync tail\nclass receiver\nright class\nleft interface\ninterface receiver\nright interface\nleft array\narray receiver\narray index\nright array\n1\n1\n1\n1\n11\n19\n31\nthen\n91'
...
run_case await_binary_array_element_postfix_update_side_effect_index_deferred_fail ""
run_case await_binary_interface_postfix_update_side_effect_receiver_deferred_fail ""
run_fail_case await_snapshot_postfix_update_target_await_fail examples/await_snapshot_postfix_update_target_await_fail.ts "await expression lowering is deferred"
run_fail_case await_snapshot_postfix_update_optional_target_fail examples/await_snapshot_postfix_update_optional_target_fail.ts "await expression lowering is deferred"
run_fail_case await_snapshot_postfix_update_conditional_target_fail examples/await_snapshot_postfix_update_conditional_target_fail.ts "await expression lowering is deferred"
