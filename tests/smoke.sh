...
run_fail_case async_await_interface_field_compound_assignment_multiple_unsafe_receiver_fail examples/async_await_interface_field_compound_assignment_multiple_unsafe_receiver_fail.ts "await expression lowering is deferred"
