...
run_fail_case await_binary_array_element_assignment_side_effect_index_deferred_fail examples/await_binary_array_element_assignment_side_effect_index_deferred_fail.ts "await expression lowering is deferred"
run_case await_binary_array_element_assignment_compound_deferred_fail $'3\n43'
run_fail_case await_binary_array_element_assignment_compound_side_effect_index_deferred_fail examples/await_binary_array_element_assignment_compound_side_effect_index_deferred_fail.ts "await expression lowering is deferred"
