...
run_fail_case await_object_literal_statement_nested_object_deferred_fail examples/await_object_literal_statement_nested_object_deferred_fail.ts "await expression lowering is deferred"
...
run_fail_case await_call_arg_nested_snapshot_array_spread_nonliteral_deferred_fail examples/await_call_arg_nested_snapshot_array_spread_nonliteral_deferred_fail.ts "await expression lowering is deferred"
