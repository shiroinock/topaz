...
run_fail_case await_binary_class_field_compound_assignment_side_effect_deferred_fail examples/await_binary_class_field_compound_assignment_side_effect_deferred_fail.ts "await expression lowering is deferred"
