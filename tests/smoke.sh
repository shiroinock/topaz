...
run_case async_await_class_field_compound_assignment_side_effect_receiver $'sync tail\nclass receiver\nclass rhs\nclass assigned\n12\n1\nclass then\n12'
run_case async_await_interface_field_compound_assignment_side_effect_receiver $'sync tail\ninterface receiver\ninterface rhs\ninterface assigned\n23\n1\ninterface then\n23'
run_case async_await_interface_field_compound_assignment_multiple $'sync tail\ninterface left\ninterface right\n13\n13\n10\ninterface then\n13'
run_case async_await_interface_field_compound_assignment_multiple_side_effect_receiver $'sync tail\nmulti left\nmulti receiver\nmulti right one\nmulti right two\nmulti expression\n16\n15\n1\nmulti then\n16'
...
run_case async_await_array_element_compound_assignment_side_effect_receiver_fail $'sync tail\nreceiver\nrhs\n12\n1\nthen\n12'
run_case async_await_array_element_compound_assignment_side_effect_index_fail $'sync tail\nindex\nrhs\n12\n20\n1\nthen\n12'
run_case async_await_array_element_compound_assignment_side_effect_receiver_index $'sync tail\nreceiver\nindex\nrhs\n12\n20\n1\n1\nthen\n12'
run_case async_await_array_element_compound_assignment_multiple $'sync tail\narray left\narray right\n13\n13\n20\narray then\n13'
run_case async_await_array_element_compound_assignment_multiple_side_effect_receiver_index $'sync tail\nleft\nreceiver\nindex\nright one\nright two\n16\n15\n20\n1\n1\nthen\n16'
run_fail_case async_await_array_element_compound_assignment_multiple_unsafe_index_fail examples/async_await_array_element_compound_assignment_multiple_unsafe_index_fail.ts "await expression lowering is deferred"
run_fail_case async_await_assignment_multiple_short_circuit_fail examples/async_await_assignment_multiple_short_circuit_fail.ts "await expression lowering is deferred"
run_fail_case async_await_property_compound_assignment_target_await_fail examples/async_await_property_compound_assignment_target_await_fail.ts "await expression lowering is deferred"
run_fail_case async_await_property_compound_assignment_optional_target_fail examples/async_await_property_compound_assignment_optional_target_fail.ts "property assignment is only supported on class instances or interface values"
run_fail_case async_await_array_element_compound_assignment_target_receiver_await_fail examples/async_await_array_element_compound_assignment_target_receiver_await_fail.ts "await expression lowering is deferred"
run_fail_case async_await_array_element_compound_assignment_target_index_await_fail examples/async_await_array_element_compound_assignment_target_index_await_fail.ts "await expression lowering is deferred"
run_fail_case async_await_array_element_compound_assignment_optional_target_fail examples/async_await_array_element_compound_assignment_optional_target_fail.ts "index assignment is only supported on Array"
...
run_case await_array_literal_spread_await_source_deferred_fail "0"
run_case await_array_literal_spread_call_source_order $'prefix\nspread await\nsync tail\nitems\n1\nlater await\nafter spread\ntail\n5\n20\nthen\n11'
run_case await_object_literal_nested_array_spread_call_source $'prefix\nspread await\nsync tail\nitems\n2\nafter spread\ntail await\nthen\nreadBox\n1\n12\n3\n4\n20'
...
run_case await_binary_array_element_assignment_compound_side_effect_index_deferred_fail $'sync tail\nleft\nindex\nright one\nright two\n16\n15\n20\n1\nthen\n16'
...
run_case await_binary_array_element_postfix_update_deferred_fail $'1\n2\n5\n4\n3\n3\n1106'
run_case await_binary_interface_postfix_update_deferred_fail $'1\n2\n5\n4\n3\n3\n1106'
run_fail_case await_binary_array_element_prefix_update_side_effect_index_deferred_fail examples/await_binary_array_element_prefix_update_side_effect_index_deferred_fail.ts "await expression lowering is deferred"
run_fail_case await_binary_interface_prefix_update_side_effect_receiver_deferred_fail examples/await_binary_interface_prefix_update_side_effect_receiver_deferred_fail.ts "await expression lowering is deferred"
run_fail_case await_binary_array_element_postfix_update_side_effect_index_deferred_fail examples/await_binary_array_element_postfix_update_side_effect_index_deferred_fail.ts "await expression lowering is deferred"
run_fail_case await_binary_interface_postfix_update_side_effect_receiver_deferred_fail examples/await_binary_interface_postfix_update_side_effect_receiver_deferred_fail.ts "await expression lowering is deferred"
