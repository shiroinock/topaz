...
run_fail_case await_binary_postfix_update_side_effect_deferred_fail examples/await_binary_postfix_update_side_effect_deferred_fail.ts "await expression lowering is deferred"
