...
run_fail_case promise_then_sentinel_return_promise_like_fail examples/promise_then_sentinel_return_promise_like_fail.ts "Promise.then callback returning PromiseLike<T> is deferred until one-handler PromiseLike bridge is implemented"
run_fail_case promise_then_two_handler_return_promise_like_fail examples/promise_then_two_handler_return_promise_like_fail.ts "Promise.then callback returning PromiseLike<T> is deferred until one-handler PromiseLike bridge is implemented"
