...
- `docs/archive/implementation-log.md` — Phase 1.5-6 prep #15 までの決定ログ(凍結)。**それ以前の各機能の lowering 詳細・回帰ケース・未対応理由はここを見る**(根拠を AGENTS.md に転記しない)
...
- **新規の決定ログは `docs/adr/NNNN-<slug>.md` に 1 ファイル = 1 決定で追記**(テンプレは `docs/adr/0000-template.md`、AGENTS.md / MEMO.md には書かない)。`docs/archive/implementation-log.md` は凍結 archive
